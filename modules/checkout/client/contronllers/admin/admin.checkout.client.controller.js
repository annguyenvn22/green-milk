        ...
        function activate() {
            ...
            vm.gridOptions = {
                columnDefs: [
                    ...
                    { field: 'checkoutType', displayName: 'Loại đơn hàng' },
                ...
                data: [
                    {customerName: 'Nguyễn Văn Chúc Ân', dateCrated: '12/12/2016', checkoutType: 'Đặt 1 lần', totalMoney: 12000, checkoutStatus: 'resolved', checkoutId: 1},   
                    {customerName: 'Hoàng Phước', dateCrated: '12/12/2016', checkoutType: 'Đặt 1 tháng', totalMoney: 12000, checkoutStatus: 'penping', checkoutId: 2} ,  
                    {customerName: 'Đăng Minh Đức', dateCrated: '12/12/2016', checkoutType: 'Đặt 1 lần', totalMoney: 12000, checkoutStatus: 'penping', checkoutId: 3}   
                ]
            }; // End: gridOptions
        }
    }
